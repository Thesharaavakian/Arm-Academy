...
var PopperAnchor = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime15.jsx)(Primitive4.div, { ...anchorProps, ref: composedRefs });
  }
);
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React20.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime16.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React20.isValidElement(newElement) ? React20.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createContextScope4(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider = (props) => {
      ...
      return (0, import_jsx_runtime18.jsx)(Context.Provider, { value, children });
    };
    Provider.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      var _a;
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React23.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime19.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React23.isValidElement(newElement) ? React23.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable6(child) {
  return React23.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
var RovingFocusGroup = React25.forwardRef(
  (props, forwardedRef) => {
    return (0, import_jsx_runtime21.jsx)(Collection.Provider, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime21.jsx)(Collection.Slot, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime21.jsx)(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }
);
...
var Menu = (props) => {
  ...
  return (0, import_jsx_runtime22.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime22.jsx)(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
...
var MenuPortal = (props) => {
  ...
  return (0, import_jsx_runtime22.jsx)(PortalProvider, { scope: __scopeMenu, forceMount, children: (0, import_jsx_runtime22.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime22.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var MenuContent = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime22.jsx)(Collection2.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime22.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime22.jsx)(Collection2.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime22.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime22.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
...
var MenuGroup = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime22.jsx)(Primitive5.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime22.jsx)(Primitive5.div, { ...labelProps, ref: forwardedRef });
  }
);
...
var MenuSubContent = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = React35.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime22.jsx)(Collection2.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime22.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime22.jsx)(Collection2.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime22.jsx)(
      MenuContentImpl,
      {
...
var DropdownMenuPortal = (props) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime23.jsx)(Portal2, { ...menuScope, ...portalProps });
};
