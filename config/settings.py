...
# Database — auto-detects postgres:// or falls back to SQLite
...
# CORS
_cors_origins = config('CORS_ALLOWED_ORIGINS', default='http://localhost:3000,http://localhost:5173', cast=Csv())
